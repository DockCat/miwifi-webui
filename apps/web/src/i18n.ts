...
const messages = {
  en: {
    ...
    'dashboard.speedtest': 'Internet Speedtest',
    'dashboard.speedtest_run': 'Run Speedtest',
    'dashboard.speedtest_running': 'Testing...',
    'dashboard.speedtest_download': 'Download',
    'dashboard.speedtest_upload': 'Upload',
    'dashboard.speedtest_ping': 'Latency',
    'dashboard.speedtest_jitter': 'Jitter',
    'dashboard.speedtest_provider': 'Provider',
    'dashboard.speedtest_provider_auto': '⚡ Auto (Router / M-Lab / Cloudflare)',
    'dashboard.speedtest_provider_mlab': '🚀 M-Lab (Google Speedtest)',
    'dashboard.speedtest_provider_cloudflare': '🌐 Cloudflare CDN',
    'dashboard.speedtest_provider_fast': '🎬 Fast.com (Netflix)',
    'dashboard.speedtest_source_router': 'Router',
    'dashboard.speedtest_source_backend': 'Server',
    'dashboard.speedtest_badge_router': 'Router Native',
    'dashboard.speedtest_badge_mlab': 'M-Lab · Server',
    'dashboard.speedtest_badge_cloudflare': 'Cloudflare · Server',
    'dashboard.speedtest_badge_fast': 'Fast.com · Server',
    'dashboard.speedtest_never': 'Never tested',
    'dashboard.speedtest_last_tested': 'Last tested',
  ...
  'zh-CN': {
    ...
    'dashboard.speedtest': '外網測速',
    'dashboard.speedtest_run': '立即測速',
    'dashboard.speedtest_running': '測速中...',
    'dashboard.speedtest_download': '下載頻寬',
    'dashboard.speedtest_upload': '上傳頻寬',
    'dashboard.speedtest_ping': '延遲',
    'dashboard.speedtest_jitter': '抖動',
    'dashboard.speedtest_provider': '測速源',
    'dashboard.speedtest_provider_auto': '⚡ 自動 (路由器 / M-Lab / Cloudflare)',
    'dashboard.speedtest_provider_mlab': '🚀 M-Lab (Google 測速同款)',
    'dashboard.speedtest_provider_cloudflare': '🌐 Cloudflare CDN',
    'dashboard.speedtest_provider_fast': '🎬 Fast.com (Netflix)',
    'dashboard.speedtest_source_router': '路由器',
    'dashboard.speedtest_source_backend': '伺服器',
    'dashboard.speedtest_badge_router': '小米路由器',
    'dashboard.speedtest_badge_mlab': 'M-Lab · 伺服器',
    'dashboard.speedtest_badge_cloudflare': 'Cloudflare · 伺服器',
    'dashboard.speedtest_badge_fast': 'Fast.com · 伺服器',
    'dashboard.speedtest_never': '尚未測速',
    'dashboard.speedtest_last_tested': '上次測試',
